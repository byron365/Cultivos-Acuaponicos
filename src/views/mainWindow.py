...
################################################################################
## Form generated from reading UI file 'HomeDYYhDb.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(u"#centralwidget,#Form{\n"
...
"color:\"white\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"CULTIVOS ACUICOLAS", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">Impulsa el futuro de la acuicultura con tecnolog\u00eda que cuida, controla y transforma tu cultivo desde el primer d\u00eda.</p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.createBtn.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"justify\">Abre una nueva ventana en donde se indicar\u00e1n los archivos .csv con los datos para analizar.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.createBtn.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Crear un nuevo proyecto (Dashboard).</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.createBtn.setText(QCoreApplication.translate("MainWindow", u"  CREAR NUEVO PROYECTO", None))
#if QT_CONFIG(tooltip)
        self.RecentBtn.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.RecentBtn.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Abrir un proyecto (Dashboard) existente.</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.RecentBtn.setText(QCoreApplication.translate("MainWindow", u"  PROYECTO RECIENTE", None))
    # retranslateUi
