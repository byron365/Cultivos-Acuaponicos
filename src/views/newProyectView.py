...
################################################################################
## Form generated from reading UI file 'nuevoProyectoEwwBtm.ui'
##
...
class Ui_centralCtn(object):
    def setupUi(self, centralCtn):
        if not centralCtn.objectName():
            centralCtn.setObjectName(u"centralCtn")
        centralCtn.resize(750, 600)
        centralCtn.setStyleSheet(u"#centralCtn{\n"
...
"}\n"
"")
        self.verticalLayout = QVBoxLayout(centralCtn)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.widget = QWidget(centralCtn)
...
"background-color: rgba(46, 204, 113,1.0);")
        ...
        self.retranslateUi(centralCtn)

        QMetaObject.connectSlotsByName(centralCtn)
    # setupUi

    def retranslateUi(self, centralCtn):
        centralCtn.setWindowTitle(QCoreApplication.translate("centralCtn", u"Nuevo Proyecto", None))
        self.label_4.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p><span style=\" font-size:11pt; font-weight:700;\">Nombre del Proyecto</span></p></body></html>", None))
        self.nameLE.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: Cultivo de Ostras", None))
        self.label_6.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\">Ruta de los archivos .csv</p></body></html>", None))
        self.label_13.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Temperatura </span></p><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Ambiente</span></p></body></html>", None))
        self.LeTa.setText("")
        self.LeTa.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: C:\\Mis arcivos\\TemperaturaAmbiente.csv", None))
        self.fTaBtn.setText("")
        self.label_12.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Temperatura </span></p><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Estanque</span></p></body></html>", None))
        self.LeTe.setText("")
        self.LeTe.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: C:\\Mis arcivos\\TemperaturaEstanque.csv", None))
        self.fTeBtn.setText("")
        self.label_11.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Ph</span></p></body></html>", None))
        self.LePh.setText("")
        self.LePh.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: C:\\Mis arcivos\\Ph.csv", None))
        self.fPhBtn.setText("")
        self.label_7.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">PPM</span></p></body></html>", None))
        self.LePpm.setText("")
        self.LePpm.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: C:\\Mis arcivos\\Ppm.csv", None))
        self.fPpmBtn.setText("")
        self.label_8.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Humedad</span></p></body></html>", None))
        self.LeHum.setText("")
        self.LeHum.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: C:\\Mis arcivos\\Humedad.csv", None))
        self.fHumBtn.setText("")
        self.label_9.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Luz </span></p><p align=\"center\"><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Ambiental</span></p></body></html>", None))
        self.LeLuz.setText("")
        self.LeLuz.setPlaceholderText(QCoreApplication.translate("centralCtn", u"Ej: C:\\Mis arcivos\\Luz.csv", None))
        self.fLuzBtn.setText("")
        self.label.setText(QCoreApplication.translate("centralCtn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:24pt;\">NUEVO PROYECTO </span></p></body></html>", None))
        self.createDashBtn.setText(QCoreApplication.translate("centralCtn", u" CREAR PROYECTO", None))
    # retranslateUi
